...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Sentry:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/getsentry/sentry-api-schema/refs/heads/main/openapi-derefed.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "SentryOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
